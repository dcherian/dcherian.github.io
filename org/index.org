...
#+HTML: <div>
I like software tools that enable easy, intuitive, convenient and scalable analysis of datasets, both big and small. So I help with building and maintaining [[http://xarray.pydata.org][xarray]]; and contribute to the wider [[http://pangeo.io][Pangeo]] ecosystem of software tools (such as [[http://xgcm.readthedocs.io][xgcm]]). [[http://discourse.pangeo.io][Come join us]]!
#+HTML: </div>
